-- NOTE: you should place the create user part -- 注意：您应该将创建用户部分
-- in a separate file and .gitignore it as it contains credentials。放在单独的文件中，并将其 .gitignore 起来，因为它包含凭据
...
GRANT ROLE movies_reader TO USER JESSIE;
